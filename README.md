...
1. Statically defined password in the [user-data](glm-cloudbaseinit-setup.ps1.template.dos#L17-L35) file.
   ...
   * In addition, the CloudBase-Init configuration file must load UserDataPlugin at some point after CreateUserPlugin but before LocalScriptPlugin
